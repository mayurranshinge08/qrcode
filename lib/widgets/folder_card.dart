            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppTheme.background,
                        borderRadius: BorderRadius.circular(12),
                        image: widget.folder.imagePath != null
                            ? DecorationImage(
                                image: AssetImage(widget.folder.imagePath!),
                                fit: BoxFit.cover,
                              )
                            : null,
                      ),
                      child: widget.folder.imagePath != null
                          ? null // Don't show icon if we have an image
                          : const Center(
                              child: Column(
                  ...
                  //     _buildMetaChip(
                  //       context,
                  //       '${widget.folder.documents.length} Items',
